...
for i in students:
    result1 = calculate_total_average(i)
    print(i["name"])
    print("=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=")
    print("Average marks of {} is : {}".format(i["name"],
                                            calculate_total_average(i)))

    print("Letter Grade of {} is : {} ".format (i["name"],assign_letter_grade(result1)))
